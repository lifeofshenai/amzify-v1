  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-bold text-gray-400">Payroll</h1>
      ...
      {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <MetricCard title="Total Employees" value={payrollData.totalEmployees} icon={<Users className="w-6 h-6" />} />
        <MetricCard
          title="Total Payroll"
