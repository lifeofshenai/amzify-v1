...
import type { PaymentStats as PaymentStatsType, WithdrawalMethod } from '../types/payment';
...
export default function Payment() {
  const [methods] = useState<WithdrawalMethod[]>(mockMethods);
  ...
  const handleRequestPayment = (methodId: string) => {
