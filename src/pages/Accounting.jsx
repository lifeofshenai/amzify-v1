  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-bold text-gray-400">Accounting</h1>
      ...
      {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <MetricCard title="Total Income" value={0} trend={15.3} icon={<DollarSign className="w-6 h-6" />} />
        <MetricCard title="Total Expenses" value={0} trend={0} icon={<FileText className="w-6 h-6" />} />
        <MetricCard title="Net Profit" value={0} subtitle={`${0}% margin`} icon={<TrendingUp className="w-6 h-6" />} />
        <MetricCard title="Estimated Tax" value={0} subtitle={`$0 paid`} icon={<PieChart className="w-6 h-6" />} />
      </div>
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="p-2 bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg">{icon}</div>
      </div>
