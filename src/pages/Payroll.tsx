...
function MetricCard({ title, value, icon, prefix = '', isDate = false }: MetricCardProps) {
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
...
function DepartmentRow({ department, employees, totalSalary, totalPayroll }: DepartmentRowProps) {
