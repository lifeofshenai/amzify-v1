...
interface LogoUploadProps {
  ...
  onLogoChange: (logoData: { url: string; colors: { primary: string; secondary: string } }) => void;
}

export default function LogoUpload({ initialLogo, onLogoChange }: LogoUploadProps) {
