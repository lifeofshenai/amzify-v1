...
interface AmazonMetricsProps {
  metrics: BrandMetrics;
}

export default function AmazonMetrics({ metrics }: AmazonMetricsProps) {
  return (
...
function PerformanceMetric({ label, value, target }: PerformanceMetricProps) {
