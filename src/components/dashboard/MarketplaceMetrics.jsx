...
function EcommerceSection({ metrics }) {
  const totalRevenue =
    metrics.channels.shopify.revenue + metrics.channels.website.revenue;
  const totalOrders =
    metrics.channels.shopify.orders + metrics.channels.website.orders;
  const avgConversion =
    (metrics.channels.shopify.conversion +
      metrics.channels.website.conversion) /
    2;
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            <ChannelMetric
              ...
              percentage={
                (metrics.channels.shopify.revenue / totalRevenue) * 100
              }
            />
            <ChannelMetric
              label="Orders"
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            <ChannelMetric
              ...
              percentage={
                (metrics.channels.website.revenue / totalRevenue) * 100
              }
            />
            <ChannelMetric
              label="Orders"
...
function TikTokSection({ metrics }) {
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-900 flex items-center">
...
function ChannelMetric({ label, value, percentage }) {
  return (
