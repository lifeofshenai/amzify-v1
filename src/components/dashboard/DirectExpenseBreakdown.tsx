...
interface DirectExpenseBreakdownProps {
  totalCogs: number;
}

export default function DirectExpenseBreakdown({ totalCogs }: DirectExpenseBreakdownProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:border-primary-200 transition-colors">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900">Direct Expense Breakdown</h3>
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <div className="flex justify-between items-center mb-3">
          <span className="text-sm font-medium text-gray-900">Total Direct Expenses</span>
          <span className="text-sm font-medium text-gray-900">
